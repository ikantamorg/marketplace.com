...
function tpl_youarehere($sep = ' » ') {
    ...
    echo '<span class="home"><bdi><a href="/knowledge-base/" class="wikilink1" title="start">Magento Extensions FAQ</a></bdi>';
    echo '</span>';
    ...
    echo $sep;
    tpl_pagelink($page, ucfirst(str_replace('_', ' ', $page)));
    return true;
}
    ...
    foreach($types as $type) {
        switch($type) {
            case 'favicon':
                ...
                $return .= '<link rel="shortcut icon" href="/images/favicon.png" />'.NL;
                break;
            case 'mobile':
                $look = array(':wiki:apple-touch-icon.png', ':apple-touch-icon.png', 'images/apple-touch-icon.png');
                $return .= '<link rel="apple-touch-icon" href="/images/favicon.png" />'.NL;
                break;
            case 'generic':
